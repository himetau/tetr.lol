...
export class ColdClear {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        ColdClearFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_coldclear_free(ptr, 0);
    }
    /**
    ...
    constructor(cols, queue, hold, back_to_back, combo, weights) {
        ...
        ColdClearFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    suggest() {
        const ret = wasm.coldclear_suggest(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
     ...
     */
    work(iters) {
        wasm.coldclear_work(this.__wbg_ptr, iters);
    }
}
if (Symbol.dispose) ColdClear.prototype[Symbol.dispose] = ColdClear.prototype.free;
...
const ColdClearFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_coldclear_free(ptr, 1));
