...
/** CC2's flat cell list [x0,y0,x1,y1,...] → [[x,y],...] */
export function pairsOf(flat: number[]): [number, number][] {
...
export class ColdClearClient {
  ...
  constructor() {
    this.worker = new Worker(new URL("../engine/cc2-worker.ts", import.meta.url), {
      type: "module",
    });
