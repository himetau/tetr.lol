...
const shotDir = '/tmp/claude-1000/-home-hayaku/d771beb1-f1ca-4f94-95ea-5c812b28f082/scratchpad/shots-h';
...
await page.evaluate(() => {
  ...
  s.handling = { ...(s.handling||{}), dasMs: 90, arrMs: 0, sdf: 41, softDropCps: 30, dcdMs: 0, cancelDasOnDirChange: false };
