...
const info = await page.evaluate(() => {
  ...
  return { border: cs.border, boxShadow: cs.boxShadow, padding: cs.padding, background: cs.backgroundColor, cornerShape: cs.cornerShape || cs.getPropertyValue('corner-shape') };
});
