...
import {
  ...
  TKI_TARGETS,
  lstStartBoard,
  type OpenerPlacement,
} from "../src/engine/opener";

// TKI flat-top "Basic Shape" placements (four.lol):
//   L__ZZ_S___
//   L___ZZSSOO
//   LL_IIIISOO
const L: OpenerPlacement = {
  piece: "L",
  cells: [
    [0, 2],
    [0, 1],
